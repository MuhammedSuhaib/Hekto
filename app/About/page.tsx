...
function AboutUsPage() {
  ...
  <div className="mt-[119px] mb-[382px] flex flex-col items-center justify-center">
    <div className="flex flex-col lg:flex-row gap-[30px]">
      ...
      <div className="md:w-[550px] w-full max-w-full p-4">
        ...
        <button
          type="submit"
          className="mt-20 h-[48px] w-[157px] rounded-[3px] bg-[#FB2E86] py-2 text-base font-medium text-white"
        >
    ...
    <div>
      ...
      >
        <div className="flex h-[320px] w-[270px] max-w-full flex-col items-center justify-center gap-[21px] shadow-md">
          <Image src="/delivery.png" width={65} height={65} alt="free delivery" />
          <h3 className="text-[22px] font-bold text-[#151875]">Free Delivery</h3>
          <p>
        ...
        <div className="flex h-[320px] w-[270px] max-w-full flex-col items-center justify-center gap-[21px] border-b-2 border-[#FF9100] shadow-md">
          <Image src="/cashback.png" width={65} height={65} alt="cashback" />
        ...
        <div className="flex h-[320px] w-[270px] max-w-full flex-col items-center justify-center gap-[21px] shadow-md">
          <Image src="/quality.png" width={65} height={65} alt="free delivery" />
          <h3 className="text-[22px] font-bold text-[#151875]">
            {" "}
            Quality Product
          </h3>
        ...
        <div className="flex h-[320px] w-[270px] max-w-full flex-col items-center justify-center gap-[21px] shadow-md">
          ...
          <h3 className="text-[22px] font-bold text-[#151875]">24/7 Support</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus
            gravida.
          </p>
    ...
    {/* Our Client Say! */}
    <div>
      <div className="mt-[204px] flex flex-col items-center justify-center text-center w-full max-w-[689px]">
        ...
        <div className={`flex justify-center items-center ${lato.className} text-[#8A8FB9] flex-col gap-[14px]`}>
          ...
          <p className="w-full md:w-full max-w-full">
