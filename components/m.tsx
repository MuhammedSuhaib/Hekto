...
// function Header() {
//   return (
//     <header className="h-[44px] w-screen flex flex-wrap items-center justify-between bg-[#7E33E0] px-4 sm:px-10">
//       {/* Left Section */}
//       <div className="flex items-center absolute sm:left-[403px]  gap-2">
...
//       {/* Middle Section */}
//       <div className="hidden sm:flex sm:absolute sm:left-[622px] items-center gap-2">
...
//       {/* Right Section */}
//       <ul className="flex items-center gap-4 text-[14px] sm:absolute sm:left-[1192px]  sm:text-[16px] text-[#F1F1F1]">
