...
// function Footer() {
//   return (
//     <div className="w-full bg-[#EEEFFB]"> {/* Added wrapper with full width */}
//       <footer className="text-base font-normal text-[#8A8FB9]">
//         {/* Main Footer Content */}
//         <div className="w-full px-6 py-10 sm:px-16">
//           <div className="mx-auto ml-[308px] mr-[446px] mt-[94px] flex max-w-full gap-12 sm:grid-cols-4">
//             {/* Hekto Section */}
//             <div>
...
//             {/* Categories Section */}
//             <div>
//               <h5 className="mb-10 w-full text-[22px] text-black">Categories</h5>
//               <ul
//                 className={`flex flex-col ${lato.className} gap-6 whitespace-nowrap`}
//               >
...
//             <div>
//               <h5 className="mb-10 w-full whitespace-nowrap text-[22px] text-black">
//                 Customer Care
//               </h5>
//               <ul
//                 className={`flex flex-col ${lato.className} gap-6 whitespace-nowrap`}
...
//         <div className="flex h-[53px] w-full items-center justify-between bg-[#E7E4F8] pl-[377px]">
...
function Footer() {
  return (
    <div className="w-full bg-[#EEEFFB]"> {/* Wrapper with full width */}
      <footer className="text-base font-normal text-[#8A8FB9]">
        {/* Main Footer Content */}
        <div className="w-full px-6 py-10 sm:px-16">
          <div className="mx-auto mt-[94px] flex flex-col sm:grid-cols-4 gap-12 sm:flex-row sm:mx-0">
            {/* Hekto Section */}
            <div>
              <h2 className="mb-4 text-[38px] font-bold text-black">Hekto</h2>
           <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row">
            ...
            {/* Customer Care Section */}
            <div>
              <h5 className="mb-10 w-full text-[22px] text-black">Customer Care</h5>
              <ul className={`flex flex-col ${lato.className} gap-6`}>
                <li>My Account</li>
                <li>Discount</li>
                <li>Returns</li>
 ...
 <div className="flex h-[53px] w-full items-center justify-between bg-[#E7E4F8] pl-0 sm:pl-[100px] md:pl-[150px] lg:pl-[200px]">
  <div className="flex flex-col sm:flex-row items-center">
    <span className={`w-[260px] font-semibold text-center sm:text-start ${lato.className}`}>
      © Webecy - All Rights Reserved
    </span>
