...
function Mi() {
  return (
    <div className="hidden md:block  2xl:w-full xl:w-[1536px]  bg-[#EEEFFB] text-[#8A8FB9]">
      <footer className="w-screen  text-base font-normal text-[#8A8FB9]">
        {/* Main Footer Content */}
        <div className="xl:ml-[10.04vh]   flex w-full flex-col px-6 py-10 sm:flex-row sm:px-16">
          <div className="mx-auto mr-[446px] mt-[94px] flex max-w-full gap-12 sm:grid-cols-4">
            ...
            <div >
              ...
              <div className="mt-4 flex  lg:h-[44px]   w-[300px] lg:w-[377px] items-center justify-end gap-4 rounded-[3px] bg-white">
                <input
                  type="email"
                ...
                <button
                  className={`h-[39px] w-[70px] lg:w-[135px] rounded-[3px]  bg-[#FB2E86] font-medium text-white ${roboto.className} `}
                >
                  Sign Up
                </button>
              </div>
            ...
            <div>
              <h5 className="mb-10 w-full lg:whitespace-nowrap text-[22px] text-black">
                Customer Care
              </h5>
              <ul
                className={`flex flex-col ${lato.className} gap-6 lg:whitespace-nowrap`}
